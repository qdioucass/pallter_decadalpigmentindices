...
ax1.set_xlabel('Retreat Proximity\n(relative days)', fontweight='normal', size=12, labelpad=2)
ax1.set_ylabel('$\mathregular{S_{Surf}}$ (g $\mathregular{kg^{-1}}$)', fontweight='normal', size=12, labelpad=6)
ax1.tick_params('x', labelbottom=True)
ax1.tick_params('both', labelsize=8)
ax1.set_ylim(32.8,34.21)
# ax1.set_xlim(10, 75)
ax1.minorticks_on()
...
filename = Path("FigS2_SALvRETR.pdf")
